...
class Jeux
{
     ...
     * @Assert\File( maxSize = "100k",uploadErrorMessage = "hghhfhgg",maxSizeMessage = "ton image est trop volumineuse (100 ko max)", mimeTypesMessage = "L'image doit être au format 'jpeg','png','gif'",mimeTypes = {"image/jpeg","image/jpg","image/png","image/gif"})
     * @Assert\NotBlank(message="100 ko max")
     */
    private $image;
